                            ...
                            if (parseFloat(objsArray[yesterdayMinusTwo].MACD) < parseFloat(objsArray[yesterdayMinusThree].MACD)) {
                                ...
                                if (parseFloat(objsArray[yesterdayMinusThree].MACD) < parseFloat(objsArray[yesterdayMinusFour].MACD)) {
                                    ...
                                    if ((drop1 < drop2) && (drop2 < drop3) && (drop3 < drop4)) {
                                        // add also here that drop1 is < 10 which could lead to patterns such as
                                        // Seems there is a deceleration pattern for HZO ---> patron fuerte
                                        // Logging sequence
                                        // 1.3373339048435349
                                        // 1.44360379163407
                                        // 13.023392962453295
                                        // 23.590864917395532
                                        // Where drop1 and drop2 are below 10 and drop 3 and drop 4 are above 10 which seems a strong pattern
                                        console.log(`Seems there is a deceleration pattern for ${instrument}`)
                                        console.log('Logging sequence')
                                        console.log(`${drop1}`)
                                        console.log(`${drop2}`)
                                        console.log(`${drop3}`)
                                        console.log(`${drop4}`)
